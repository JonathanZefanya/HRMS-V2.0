                                                        ...
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Performance Type')): ?>
                                                            <div class="action-btn me-2">
                                                                <a href="#" class="btn btn-sm align-items-center bg-info"
                                                                    data-url="<?php echo e(route('performanceType.edit', $performance_type->id)); ?>"
                                                                    data-ajax-popup="true" data-title="<?php echo e(__('Edit Performance Type')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project-website\HRMS\resources\views/performance_type/index.blade.php ENDPATH**/ ?>