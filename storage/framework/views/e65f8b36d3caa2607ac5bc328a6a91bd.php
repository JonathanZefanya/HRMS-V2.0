                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Expense Type')): ?>
                                                        <div class="action-btn me-2">
                                                            <a href="#" class="btn btn-sm align-items-center bg-info"
                                                                data-url="<?php echo e(route('expensetype.edit', $expensetype->id)); ?>"
                                                                data-ajax-popup="true" data-title="<?php echo e(__('Edit Expense Type')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project-website\HRMS\resources\views/expensetype/index.blade.php ENDPATH**/ ?>