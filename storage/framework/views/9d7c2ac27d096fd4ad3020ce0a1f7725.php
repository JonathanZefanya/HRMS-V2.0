...
<?php $__env->startSection('action-button'); ?>
    <a href="#" data-url="<?php echo e(route('assets.file.import')); ?>" data-ajax-popup="true"
        data-title="<?php echo e(__('Import  Asset CSV file')); ?>" data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary me-1"
                                        ...
                                        <div class="avatar-group">
                                            <?php $__currentLoopData = $asset->users($asset->employee_id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a href="#" class="avatar rounded-circle avatar-sm avatar-group">
                                                    <img alt="" <?php if(!empty($user->avatar)): ?> src="<?php echo e($profile.'/'.$user->avatar); ?>" <?php else: ?> src="<?php echo e(asset('/storage/uploads/avatar/avatar.png')); ?>" <?php endif; ?> title="<?php echo e((!empty($user)?$user->name:'')); ?>" data-bs-toggle="tooltip" height="30px" width="30px" style="border-radius:50%" title="<?php echo e((!empty($user)?$user->name:'')); ?>" class="">
                                                </a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project-website\HRMS\resources\views/assets/index.blade.php ENDPATH**/ ?>