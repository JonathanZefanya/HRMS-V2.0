            ...
            <div class="my-3 d-flex justify-content-end">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Goal Type')): ?>
                    <a href="#" data-url="<?php echo e(route('goaltype.create')); ?>" data-ajax-popup="true"
                        data-title="<?php echo e(__('Create New Goal Type')); ?>" data-bs-toggle="tooltip" title=""
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project-website\HRMS\resources\views/goaltype/index.blade.php ENDPATH**/ ?>