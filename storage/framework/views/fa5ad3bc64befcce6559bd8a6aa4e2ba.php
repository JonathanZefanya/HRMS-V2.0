                                                        ...
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Show Indicator')): ?>
                                                            <div class="action-btn bg-warning me-2">
                                                                <a href="#" class="mx-3 btn btn-sm  align-items-center"
                                                                    ...
                                                                    data-title="<?php echo e(__('Indicator Detail ')); ?>"
                                                        ...
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Indicator')): ?>
                                                            <div class="action-btn bg-info me-2">
                                                                <a href="#" class="mx-3 btn btn-sm  align-items-center"
                                                                    ...
                                                                    data-ajax-popup="true" data-size="md"
                                                                    data-bs-toggle="tooltip" title=""
                                                                    data-title="<?php echo e(__('Edit Indicator')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project-website\HRMS\resources\views/indicator/index.blade.php ENDPATH**/ ?>