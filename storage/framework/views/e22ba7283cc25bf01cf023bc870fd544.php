                                    ...
                                    <div class="col-auto mb-3 mb-sm-0">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3">
                                                <small class="text-muted"><?php echo e(__('Total')); ?></small>
                                                <h6 class="m-0"><a
                                                    href="<?php echo e(route('accountlist.index')); ?>"><?php echo e(__('Account Balance')); ?></a></h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-auto text-end">
                            ...
                            <div class="col-auto mb-3 mb-sm-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <small class="text-muted"><?php echo e(__('Total')); ?></small>
                                        <h6 class="m-0"><a
                                            href="<?php echo e(route('job.index')); ?>"><?php echo e(__('Jobs')); ?></a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-auto text-end">
                            ...
                            <div class="col-auto mb-3 mb-sm-0">
                                <div class="d-flex align-items-center">
                                    <div class="badge theme-avtar bg-info text-white">
                                        <svg xmlns="<?php echo e(asset($icons . 'active.svg')); ?>" width="40" height="40" viewBox="0 0 40 40">
                                            <rect width="20" height="20" fill="none"></rect>
                                            <image href="<?php echo e(asset($icons . 'active.svg')); ?>" x="0" y="0" width="40" height="40" />
                                        </svg>
                                    </div>
                                    <div class="ms-3">
                                        <small class="text-muted"><?php echo e(__('Total')); ?></small>
                    ...
                    <div class="card-body stats">
                        <div class="row align-items-center justify-content-between">
                            <div class="col-auto mb-3 mb-sm-0">
                                <div class="d-flex align-items-center">
                                    <div class="badge theme-avtar bg-warning">
                                        <svg xmlns="<?php echo e(asset($icons . 'inactive.svg')); ?>" width="20" height="20" viewBox="0 0 40 40">
                                            <rect width="20" height="20" fill="none"></rect>
                                            <image href="<?php echo e(asset($icons . 'inactive.svg')); ?>" x="0" y="0" width="40" height="40" />
                                        </svg>
                                    </div>
                                    <div class="ms-3">
                                        <small class="text-muted"><?php echo e(__('Total')); ?></small>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project-website\HRMS\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>