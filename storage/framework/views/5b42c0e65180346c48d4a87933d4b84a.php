                    ...
                    <div class="d-flex align-items-center justify-content-end">
                        ...
                        <div class="col-auto float-end mt-4">
                            <a href="#" onclick="document.getElementById('payslip_form').submit(); return false;"
                                data-title="<?php echo e(__('Generate Payslip')); ?>" data-bs-toggle="tooltip"
                                title="<?php echo e(__('Generate Payslip')); ?>" data-original-title="<?php echo e(__('payslip')); ?>"
                    ...
                    <div class="col-md-8">
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <?php if(Auth::user()->type == 'company' || Auth::user()->type == 'hr'): ?>
                                ...
                                <input type="submit" value="<?php echo e(__('Export')); ?>" class="btn btn-primary me-1">
                                <?php echo e(Form::close()); ?>
                        ...
                        if (data.length > 0) {
                            $.each(data, function(indexInArray, valueOfElement) {
                                ...
                                if (valueOfElement[7] != 0) {
                                    ...
                                    //     id +
                                    //     '/' + datePicker +
                                    //     '" data-size="lg" data-toggle="tooltip" title="<?php echo e(__('Payslip')); ?>" data-ajax-popup="true" class=" btn-sm btn btn-warning me-1" data-title="<?php echo e(__('Employee Payslip')); ?>">' +
                                    //     '<i class="ti ti-report-money"></i>' + '</a> ';
                                    var payslip =
                                        '<a href="#" data-url="<?php echo e(url('payslip/pdf/')); ?>/' +
                                        id +
                                        '/' + datePicker +
                                        '" class="btn-sm btn btn-warning me-2" data-size="lg" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__('Payslip')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Employee Payslip')); ?>">' +
                                        '<i class="ti ti-report-money"></i>' +
                                        '</a>';
                                }
                                if (valueOfElement[6] == "UnPaid" && valueOfElement[7] != 0) {
                                    var clickToPaid =
                                        ...
                                        '/' + datePicker +
                                        '" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__('Click To Paid')); ?>" class="btn-sm btn btn-primary me-1">' +
                                ...
                                if (valueOfElement[7] != 0 && valueOfElement[6] == "UnPaid") {
                                    var edit =
                                        '<a href="#" data-url="<?php echo e(url('payslip/editemployee/')); ?>/' +
                                        payslip_id +
                                        '"  data-ajax-popup="true" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__('Edit')); ?>" data-size="lg" class="btn-sm btn btn-info me-2" data-title="<?php echo e(__('Edit Employee salary')); ?>">' +
                                ...
                                <?php if(\Auth::user()->type == 'company' || \Auth::user()->type == 'hr'): ?>
                                    var deleted = '<a href="#"  data-url="' + url +
                                        '" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__('Delete')); ?>" class="payslip_delete view-btn btn btn-danger btn-sm"  >' +
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project-website\HRMS\resources\views/payslip/index.blade.php ENDPATH**/ ?>