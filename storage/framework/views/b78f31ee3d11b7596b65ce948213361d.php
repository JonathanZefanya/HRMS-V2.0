                                            ...
                                            <td class="Action">
                                                <?php if($employee->user->is_active == 1 && $employee->user->is_disable == 1): ?>
                                                    <div class="dt-buttons">
                                                        <span>
                                                            <?php if(\Auth::user()->type == 'company' || \Auth::user()->type == 'company'): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project-website\HRMS\resources\views/employee/index.blade.php ENDPATH**/ ?>