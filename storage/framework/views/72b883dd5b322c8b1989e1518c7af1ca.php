...
<?php $__env->startSection('action-button'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Company Policy')): ?>
        <a href="#" data-url="<?php echo e(route('company-policy.create')); ?>" data-ajax-popup="true"
            data-title="<?php echo e(__('Create New Company Policy')); ?>" data-size="md" data-bs-toggle="tooltip" title=""
                                            ...
                                            <?php if(!empty($policy->attachment)): ?>
                                                <div class="dt-buttons">
                                                    ...
                                                    data-bs-original-title="<?php echo e(__('Download')); ?>"
                                                                href="<?php echo e($policyPath . '/' . $policy->attachment); ?>"
                                                                download="">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project-website\HRMS\resources\views/companyPolicy/index.blade.php ENDPATH**/ ?>