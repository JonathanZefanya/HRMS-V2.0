            ...
            <div class="my-3 d-flex justify-content-end">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Branch')): ?>
                    <a href="#" data-url="<?php echo e(route('leavetype.create')); ?>" data-ajax-popup="true"
                        data-title="<?php echo e(__('Create New Leave Type')); ?>" data-bs-toggle="tooltip" title=""
                                                            ...
                                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Leave Type')): ?>
                                                                <div class="action-btn me-2">
                                                                    <a href="#" class="btn btn-sm align-items-center bg-info"
                                                                        data-url="<?php echo e(route('leavetype.edit', $leavetype->id)); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project-website\HRMS\resources\views/leavetype/index.blade.php ENDPATH**/ ?>